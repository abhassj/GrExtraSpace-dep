...
export default function OurStorySection() {
  return (
    <section className="relative overflow-hidden bg-brand-paper py-16 sm:py-24 md:py-32" id="our-story">
      ...
      <div className="section-wrap relative z-10">
        <div className="section-inner max-w-[1200px]">
          ...
          >
            <div className="mb-5 inline-flex items-center gap-2 border border-brand-navy/10 bg-white/50 px-3 py-2 backdrop-blur-md sm:mb-6 sm:px-4">
              <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-brand-navy">Our History</span>
            </div>

            <h2 className="mt-2 font-display text-[2rem] font-medium leading-[1.08] tracking-[-0.01em] text-brand-navy sm:text-4xl md:text-5xl lg:text-[4rem]">
          ...
          <MotionDiv
            ...
            className="mx-auto mt-10 grid gap-8 sm:mt-16 sm:gap-10 lg:grid-cols-2 lg:gap-20"
          >
            <div className="space-y-5 text-[15px] leading-relaxed text-brand-navy/75 sm:space-y-6 sm:text-base md:text-lg">
              <p>
          ...
          <MotionDiv
            ...
            className="mt-12 h-px w-full bg-brand-navy/10 origin-left sm:mt-20"
          />
        </div>
      </div>
    </section>
