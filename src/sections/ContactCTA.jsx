        ...
        <div className="section-inner">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:gap-20">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 right-4 flex lg:hidden flex-col justify-center bg-brand-navy px-6 py-4 text-white shadow-2xl z-10">
                <p className="font-display text-2xl leading-none">4th</p>
            ...
            <div>
              ...
              <p className="mt-6 font-display text-xl text-brand-navy/90 sm:mt-8 sm:text-2xl">
                Let's create something great together
              </p>

              <p className="mt-4 max-w-lg text-sm leading-relaxed text-brand-navy/70 sm:mt-6 sm:text-base">
              ...
              <div className="mt-8 grid max-w-md grid-cols-2 gap-4 border-y border-brand-navy/15 py-5 sm:mt-10 sm:gap-6 sm:py-6">
                ...
                <div>
                  ...
                  <p className="mt-3 font-display text-lg text-brand-navy">{saOffice.region}</p>
                  <p className="mt-1 text-xs text-brand-navy/65">
